...
﻿# Release v2026.06.05.6 - Details

## Release metadata

- Version: `v2026.06.05.6`
- Development start: `2026-06-05T12:54:40+02:00`
- Development end: `2026-06-05T12:59:13+02:00`
- Release branch: `main`
- Release commit: `4322ead3138c1373874c532e4174f8eb7bea4867`

## Summary

1. Aligned infra and CI/CD documentation with *local server* terminology (`286f471`).
2. Added `infra/local-server.env.example` for portable service URL configuration.
3. Release metadata and project-structure TOC sync (automated pre-commit).
