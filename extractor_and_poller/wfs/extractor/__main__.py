...
PACKAGE_DIR = Path(__file__).resolve().parent               # extractor/wfs/
EXTRACTORS_ROOT = PACKAGE_DIR.parent                        # extractor/
...
from extractor_and_poller.wfs.extractor import gml_parser
