...
Run from ``data-solution-2026/``::
    ...
    python -m extractor_and_poller.knmi.extractor --list
    python -m extractor_and_poller.knmi.extractor --mapping knmi-daggegevens-temperature
    python -m extractor_and_poller.knmi.extractor --mapping knmi-daggegevens-temperature --filename daily-observations-20260521.nc
"""
...
from extractor_and_poller.knmi.extractor import netcdf_parser
