...
Run as a module from the ``data-solution-2026/`` directory::
    ...
    python -m extractor_and_poller.odata.extractor --list
    python -m extractor_and_poller.odata.extractor --config data-object-mapping/odata-demo.json --mapping odata-demo-regions
    python -m extractor_and_poller.odata.extractor --mapping cbs-84583NED --limit 5000
"""
...
from extractor_and_poller.odata.extractor import client as odata_module
