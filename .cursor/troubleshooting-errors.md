...
|-------|-------|
| **When** | 2026-06-03 (backfill) |
| **Context** | SSH $LOCAL_SERVER_SSH, agent troubleshooting |
...
| **Command** | Open `https://airflow.example/` |
...
|-------|-------|
| **When** | 2026-06-03 (backfill) |
| **Context** | NAS Airflow via NGINX `https://airflow.example/` |
...
|-------|-------|
| **When** | 2026-06-03 (backfill) |
| **Context** | SSH $LOCAL_SERVER_SSH, `git pull` / deploy |
| **Command** | `git …` |
...
|-------|-------|
| **When** | 2026-06-03 |
| **Context** | SSH $LOCAL_SERVER_SSH, `infra/scripts/` |
...
|-------|-------|
| **When** | 2026-06-03 |
| **Context** | Local → local server, immediately after enable-nas-ssh-user-env |
| **Command** | `ssh $LOCAL_SERVER_SSH` |
